...
const boardData = [
  ...
  { id: 1, type: 'property', name: 'Marvel', group: 'media', price: 60, rent: 2 },
  { id: 2, type: 'property', name: 'Pixar', group: 'media', price: 60, rent: 4 },
  { id: 3, type: 'chance', name: 'Task' },
  { id: 4, type: 'tax', name: 'GiveUser', price: 200 }, 
  { id: 5, type: 'property', name: 'Audi', group: 'auto', price: 200, rent: 25 },
  { id: 6, type: 'property', name: 'Sprite', group: 'drinks', price: 100, rent: 6 },
  { id: 7, type: 'property', name: 'Fanta', group: 'drinks', price: 100, rent: 6 }, 
  { id: 8, type: 'property', name: 'Minecraft', group: 'games', price: 100, rent: 6 },
  { id: 9, type: 'property', name: 'CocaCola', group: 'drinks', price: 120, rent: 8 },

  { id: 10, type: 'casino', name: 'Casino'},
  { id: 11, type: 'property', name: 'Starbucks', group: 'coffee', price: 150, rent: 4 },
  { id: 12, type: 'chance', name: 'Task' },
  { id: 13, type: 'property', name: 'Blue Bottle', group: 'coffee', price: 140, rent: 10 },
  { id: 14, type: 'property', name: 'Lavazza', group: 'coffee', price: 160, rent: 12 },
  { id: 15, type: 'property', name: 'BMW', group: 'auto', price: 200, rent: 25 },
  { id: 16, type: 'property', name: 'McDonalds', group: 'fastfood', price: 180, rent: 14 },
  { id: 17, type: 'property', name: 'KFS', group: 'fastfood', price: 180, rent: 14 },
  { id: 18, type: 'chance', name: 'Task' },
  { id: 19, type: 'property', name: 'Pizza Hut', group: 'fastfood', price: 200, rent: 16 },

  { id: 20, type: 'jail', name: 'Free Parking' },
  { id: 21, type: 'property', name: 'Telegram', group: 'messenger', price: 220, rent: 18 },
  { id: 22, type: 'property', name: 'WhatsApp', group: 'messenger', price: 220, rent: 18 },
  { id: 23, type: 'property', name: 'Instagram', group: 'messenger', price: 240, rent: 20 },
  { id: 24, type: 'chance', name: 'Task' },
  { id: 25, type: 'property', name: 'Lamborghini', group: 'auto', price: 200, rent: 25 },
  { id: 26, type: 'tax', name: 'Give to bank', price: 260},
  { id: 27, type: 'property', name: 'Apple', group: 'device', price: 280, rent: 24 },
  { id: 28, type: 'chance', name: 'Task' },
  { id: 29, type: 'property', name: 'PlayStation', group: 'device', price: 150, rent: 4 },
  
  { id: 30, type: 'go_jail', name: 'Go Jail' },
  { id: 31, type: 'property', name: 'Yakuza', group: 'mafia', price: 300, rent: 26 },
  { id: 32, type: 'property', name: 'Assassins Creed', group: 'games', price: 300, rent: 26 },
  { id: 33, type: 'property', name: 'Cosa Nostra', group: 'mafia', price: 320, rent: 28 },
  { id: 34, type: 'property', name: 'Triads', group: 'mafia', price: 350, rent: 35 },
  { id: 35, type: 'property', name: 'Mersedes-Benz', group: 'auto', price: 200, rent: 25 },
  { id: 36, type: 'property', name: 'Gucci', group: 'cloths', price: 350, rent: 35 },
  { id: 37, type: 'chance', name: 'Task' },
  { id: 38, type: 'property', name: 'Nike', group: 'cloths', price: 400, rent: 50 },
  { id: 39, type: 'property', name: 'Adidas', group: 'cloths', price: 400, rent: 50 }
];
